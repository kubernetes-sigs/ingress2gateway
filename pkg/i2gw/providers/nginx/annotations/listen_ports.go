...
func ListenPortsFeature(_ notifications.NotifyFunc, ingresses []networkingv1.Ingress, _ map[types.NamespacedName]map[string]int32, ir *providerir.ProviderIR) field.ErrorList {
...
func replaceGatewayPortsWithCustom(ingress networkingv1.Ingress, portConfiguration portConfiguration, ir *providerir.ProviderIR) field.ErrorList {
	...
	if !exists {
		gatewayContext = providerir.GatewayContext{
