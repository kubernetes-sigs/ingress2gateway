...
// Package traefik implements an ingress2gateway provider that converts Traefik
...
// NewProvider constructs and returns the Traefik implementation of i2gw.Provider.
...
// ToIR converts stored Traefik Ingress resources to emitterir.EmitterIR,
// including Traefik-specific annotation translations.
