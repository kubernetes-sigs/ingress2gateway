...
func buildGceGatewayIR(ctx context.Context, storage *storage, ir *provider_intermediate.ProviderIR) {
	if ir.Gateways == nil {
...
func feConfigToGceGatewayIR(feConfig *frontendconfigv1beta1.FrontendConfig) gce.GceGatewayIR {
	var gceGatewayIR gce.GceGatewayIR
...
func buildGceServiceIR(ctx context.Context, storage *storage, ir *provider_intermediate.ProviderIR) {
	if ir.Services == nil {
...
func beConfigToGceServiceIR(beConfig *backendconfigv1.BackendConfig) gce.GceServiceIR {
	var gceServiceIR gce.GceServiceIR
